...
def main() -> None:
    ...
    # Сценарий 1: Generic коллекция (на 3)
    print("\n--- Сценарий 1: TypedCollection[T] ---")
    ...
    products.add(Product(1500, 10, 25, "available", 1, "Ноутбук"))
    products.add(Product(500, 0, 100, "available", 2, "Мышь"))
    products.add(Product(3000, 5, 3, "available", 3, "Смартфон"))
    products.add(FoodProduct(100, 0, 30, "available", 4, "Молоко",
    ...
    # Сценарий 3: TypedCollection[D] (Displayable) (на 5)
    ...
    print("Объекты с методом display():")
    for item in displayable_coll.get_all():
        print(f"  {item.display()}")
    
    # Сценарий 4: TypedCollection[S] (Scorable) (на 5)
